...
--DROP TABLE PRPURCHASEORDER;
--DROP TABLE PRPURCHASEORDERITEMS;
...
--SELECT * FROM PRPURCHASEORDER;
--SELECT * FROM PRPURCHASEORDERITEMS;
...
--implementing constraints
ALTER TABLE PRPURCHASEORDER
ADD CONSTRAINT P_o_receiver_id_fk
FOREIGN KEY (receiver_id) REFERENCES PREMPLOYEES(employee_id);

--data insersion in table purchase_order
INSERT ALL 
INTO PRPURCHASEORDER (po_id,receiver_id,po_date) VALUES ('1010',6001,'12-DEC-17')
INTO PRPURCHASEORDER (po_id,receiver_id,po_date) VALUES ('2020',6002,'02-JAN-19')
INTO PRPURCHASEORDER (po_id,receiver_id,po_date) VALUES ('3030',6003,'27-APR-17')
INTO PRPURCHASEORDER (po_id,receiver_id,po_date) VALUES ('4040',6004,'12-NOV-19')
INTO PRPURCHASEORDER (po_id,receiver_id,po_date) VALUES ('5050',6005,'04-JAN-18')
INTO PRPURCHASEORDER (po_id,receiver_id,po_date) VALUES ('6060',6006,'29-MAR-18')
INTO PRPURCHASEORDER (po_id,receiver_id,po_date) VALUES ('7070',6007,'06-MAY-17')
INTO PRPURCHASEORDER (po_id,receiver_id,po_date) VALUES ('8080',6002,'11-FEB-18')
INTO PRPURCHASEORDER (po_id,receiver_id,po_date) VALUES ('9090',6005,'11-NOV-19')
INTO PRPURCHASEORDER (po_id,receiver_id,po_date) VALUES ('1011',6006,'14-FEB-18')
SELECT * FROM dual;


--table creation: purchase_order_items
CREATE TABLE PRPURCHASEORDERITEMS(
product_id NUMBER(5),
po_id NUMBER(5),
cost NUMBER(5),
quantity NUMBER(4)
...
--implementing constraints
ALTER TABLE PRPURCHASEORDERITEMS
ADD CONSTRAINT p_o_items_product_id_fk
FOREIGN KEY (product_id) REFERENCES PRPRODUCT(product_id);

ALTER TABLE PRPURCHASEORDERITEMS
ADD CONSTRAINT p_o_items_po_id_fk
FOREIGN KEY (po_id) REFERENCES PRPURCHASEORDER(po_id);

--data insertion in purchase_order_items
INSERT ALL 
INTO PRPURCHASEORDERITEMS (product_id,po_id,cost,quantity) values (8001,1010,20.21,9)
INTO PRPURCHASEORDERITEMS (product_id,po_id,cost,quantity) values (8005,1011,40.65,12)
INTO PRPURCHASEORDERITEMS (product_id,po_id,cost,quantity) values (8026,2020,200.21,23)
INTO PRPURCHASEORDERITEMS (product_id,po_id,cost,quantity) values (8015,3030,90.56,34)
INTO PRPURCHASEORDERITEMS (product_id,po_id,cost,quantity) values (8025,4040,95.98,45)
INTO PRPURCHASEORDERITEMS (product_id,po_id,cost,quantity) values (8007,5050,109.83,56)
INTO PRPURCHASEORDERITEMS (product_id,po_id,cost,quantity) values (8017,6060,34.52,67)
INTO PRPURCHASEORDERITEMS (product_id,po_id,cost,quantity) values (8008,7070,5.99,3)
INTO PRPURCHASEORDERITEMS (product_id,po_id,cost,quantity) values (8021,8080,66.76,23)
INTO PRPURCHASEORDERITEMS (product_id,po_id,cost,quantity) values (8009,9090,77.67,78)
INTO PRPURCHASEORDERITEMS (product_id,po_id,cost,quantity) values (8022,1010,88.98,100)
INTO PRPURCHASEORDERITEMS (product_id,po_id,cost,quantity) values (8010,2020,11.34,6)
INTO PRPURCHASEORDERITEMS (product_id,po_id,cost,quantity) values (8023,3030,55.21,75)
INTO PRPURCHASEORDERITEMS (product_id,po_id,cost,quantity) values (8011,4040,88.65,144)
INTO PRPURCHASEORDERITEMS (product_id,po_id,cost,quantity) values (8024,9090,99.55,72)
SELECT * FROM dual;

UPDATE PRPURCHASEORDER po
SET po.total_cost = (SELECT ROUND(SUM(poi.cost * poi.quantity),2) FROM PRPURCHASEORDERITEMS poi WHERE po.po_id = poi.po_id);
...
INSERT INTO PRORDER (customer_id, packer_id,order_date) VALUES (1000,6000,'21-JAN-18'); 
INSERT INTO PRORDER (customer_id, packer_id,order_date) VALUES (1001,6001,'18-MAR-19'); 
INSERT INTO PRORDER (customer_id, packer_id,order_date) VALUES (1002,6002,'12-JUN-17');  
INSERT INTO PRORDER (customer_id, packer_id,order_date) VALUES (1003,6003,'24-DEC-19');
INSERT INTO PRORDER (customer_id, packer_id,order_date) VALUES (1004,6004,'15-FEB-18');
INSERT INTO PRORDER (customer_id, packer_id,order_date) VALUES (1005,6005,'03-JUL-18'); 
INSERT INTO PRORDER (customer_id, packer_id,order_date) VALUES (1006,6006,'22-AUG-17');
INSERT INTO PRORDER (customer_id, packer_id,order_date) VALUES (1007,6007,'29-APR-18'); 
INSERT INTO PRORDER (customer_id, packer_id,order_date) VALUES (1008,6005,'10-JAN-19'); 
INSERT INTO PRORDER (customer_id, packer_id,order_date) VALUES (1009,6004,'14-MAR-18'); 
INSERT INTO PRORDER (customer_id, packer_id,order_date) VALUES (1010,6002,'05-MAY-17');
INSERT INTO PRORDER (customer_id, packer_id,order_date) VALUES (1011,6003,'01-JUN-18');
INSERT INTO PRORDER (customer_id, packer_id,order_date) VALUES (1012,6007,'12-NOV-19');
INSERT INTO PRORDER (customer_id, packer_id,order_date) VALUES (1013,6001,'21-OCT-18');
INSERT INTO PRORDER (customer_id, packer_id,order_date) VALUES (1014,6003,'26-OCT-17');
INSERT INTO PRORDER (customer_id, packer_id,order_date) VALUES (1015,6006,'09-DEC-18');
...
INSERT INTO PRORDERITEMS (product_id,order_id,price,quantity) values (8005,9001,43.53,2);
INSERT INTO PRORDERITEMS (product_id,order_id,price,quantity) values (8026,9002,210.33,5);
INSERT INTO PRORDERITEMS (product_id,order_id,price,quantity) values (8015,9003,100.22,6);
INSERT INTO PRORDERITEMS (product_id,order_id,price,quantity) values (8026,9004,100.33,7);
INSERT INTO PRORDERITEMS (product_id,order_id,price,quantity) values (8007,9005,110.87,8);
INSERT INTO PRORDERITEMS (product_id,order_id,price,quantity) values (8017,9006,35.99,4);
INSERT INTO PRORDERITEMS (product_id,order_id,price,quantity) values (8008,9007,8.40,1);
INSERT INTO PRORDERITEMS (product_id,order_id,price,quantity) values (8021,9008,70.99,1);
INSERT INTO PRORDERITEMS (product_id,order_id,price,quantity) values (8009,9009,80.80,20);
INSERT INTO PRORDERITEMS (product_id,order_id,price,quantity) values (8022,9010,90.23,10);
INSERT INTO PRORDERITEMS (product_id,order_id,price,quantity) values (8010,9011,15.43,5);
INSERT INTO PRORDERITEMS (product_id,order_id,price,quantity) values (8023,9012,58.22,45);
INSERT INTO PRORDERITEMS (product_id,order_id,price,quantity) values (8011,9013,90.12,110);
INSERT INTO PRORDERITEMS (product_id,order_id,price,quantity) values (8024,9014,100.64,72);
INSERT INTO PRORDERITEMS (product_id,order_id,price,quantity) values (8025,9015,21.77,72);
...
INSERT INTO PRSHIPPING (tracking_number,order_id,shipper_id,ship_status,ship_date) VALUES (1010101010,9001,10005,1,'28-MAR-19');
INSERT INTO PRSHIPPING (tracking_number,order_id,shipper_id,ship_status,ship_date) VALUES (2020202020,9002,10004,1,'16-JUN-17');
INSERT INTO PRSHIPPING (tracking_number,order_id,shipper_id,ship_status,ship_date) VALUES (3030303030,9003,10004,0,'05-JAN-20');
INSERT INTO PRSHIPPING (tracking_number,order_id,shipper_id,ship_status,ship_date) VALUES (4040404040,9004,10002,0,'25-FEB-18');
INSERT INTO PRSHIPPING (tracking_number,order_id,shipper_id,ship_status,ship_date) VALUES (5050505050,9005,10001,0,'23-JUL-18');
INSERT INTO PRSHIPPING (tracking_number,order_id,shipper_id,ship_status,ship_date) VALUES (6060606060,9006,10001,0,'04-SEP-17');
INSERT INTO PRSHIPPING (tracking_number,order_id,shipper_id,ship_status,ship_date) VALUES (7070707070,9007,10001,0,'10-MAY-18');
INSERT INTO PRSHIPPING (tracking_number,order_id,shipper_id,ship_status,ship_date) VALUES (8080808080,9008,10004,1,'22-JAN-19');
INSERT INTO PRSHIPPING (tracking_number,order_id,shipper_id,ship_status,ship_date) VALUES (9090909090,9009,10002,1,'16-MAR-18');
INSERT INTO PRSHIPPING (tracking_number,order_id,shipper_id,ship_status,ship_date) VALUES (1011101110,9010,10005,1,'17-MAY-17');
